...
::
::
:: NOTE: Firo will fork to firopow on Tue Oct 26 2021 06:00:00 GMT+0000. Before then this script will not result
::       in valid mining. Use the testnet script instead, start_firo_testnet.bat.
::
:: Example:
teamredminer.exe -a firopow -o stratum+tcp://firo.mintpond.com:3000 -u aPZL3WsQ1MAV4Ff16J4oEvCwzCpnzsn9j9 -p x
